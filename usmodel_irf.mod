 ...
 * Date: Sept, 2026
 * 
 * This file estimates the model and computes the IRFs.
 * 
 * Inputs:
 *   - usmodel_data.mat
 *   - irf=16 (hyperparameter in `stoch_simul()`)
 * Outputs:
 *   - You should run `plot_irf.m` to obtain the impulse responses of the 7 observable variables
 *       to each of the 7 shocks.
 *   - This file is a part of `plot_irf.m`.
 *
 * Notes:
...
//posterior_mode = oo_.posterior_mode; 
//save('usmodel_mode.mat', 'posterior_mode');
